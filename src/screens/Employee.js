...
export default function Employee() {
  ...
  return (
    <View style={styles.container}>
      ...
      <Button mode="contained" onPress={guardarEmpleado} style={styles.boton}>
      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          <Card style={styles.card}>
            ...
            <Card.Actions>
              <Button onPress={() => editarEmpleado(item)}>Editar</Button>
              <Button onPress={() => eliminarEmpleado(item.id)}>Eliminar</Button>
            </Card.Actions>
          </Card>
        )}
      />
...
const styles = StyleSheet.create({
  ...
  titulo: { fontSize: 22, textAlign: "center", marginVertical: 15, fontWeight: "bold" },
